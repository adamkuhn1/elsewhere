...
// captures (recapture must not pay the model-load cost twice -- see
// Phase 11's recapture test). No worker protocol beyond the three messages
// worker.ts already speaks; this is deliberately not a generic RPC layer.
// ---------------------------------------------------------------------------
